define("cats-client/initializers/ajax",["exports"],function(e){"use strict"
...
e.default=o}),define("cats-client/initializers/error-handler",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
e.default=t}),define("cats-client/instance-initializers/ember-data-fastboot",["exports"],function(e){"use strict"
...
r.put("ember-data-store",{get records(){return o.map(function(e){return t.peekAll(e).toArray()}).reduce(function(e,t){return e.concat(t)},[]).filter(function(e){return e.get("isLoaded")&&!e.get("isNew")}).map(function(e){return e.serialize({includeId:!0})}).reduce(function(e,t){return e.data.push(t.data),e},{data:[]})}})}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=t,e.default=void 0
var r={name:"ember-data-fastboot",initialize:t}
e.default=r})
